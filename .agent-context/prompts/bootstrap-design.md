...
- Domain: Frontend/UI application
...
```json
{
  ...
  "aiSafeUiAudit": {
    ...
    "interchangeabilityTest": "If this UI can be renamed from HMTI MARGONDA to another product category without changing composition, palette, iconography, and motion, revise it.",
  ...
  "designExecutionHandoff": {
    ...
    "primaryExperienceGoal": "Define the main frontend/ui application journey for HMTI MARGONDA from repo evidence, brief, and docs.",
    "surfacePlan": [
      {
    ...
    "taskFlowNarrative": [
      "Entry: start HMTI MARGONDA from real evidence, not a generic opener.",
